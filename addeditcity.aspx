<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="addeditcity.aspx.cs" Inherits="addeditcity" %>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="col-xs-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ControlToValidate="txtcityname" ValidationGroup="gg"  runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>   
